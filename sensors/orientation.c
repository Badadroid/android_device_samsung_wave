...
struct orientation_data {
	struct wave_sensors_handlers *acceleration_sensor;
	struct wave_sensors_handlers *magnetic_sensor;
...
int orientation_init(struct wave_sensors_handlers *handlers,
...
int orientation_deinit(struct wave_sensors_handlers *handlers)
{
	struct orientation_data *data;
...
int orientation_activate(struct wave_sensors_handlers *handlers)
{
	struct orientation_data *data;
	...
	data->acceleration_sensor->needed |= WAVE_SENSORS_NEEDED_ORIENTATION;
	if (data->acceleration_sensor->needed == WAVE_SENSORS_NEEDED_ORIENTATION)
		data->acceleration_sensor->activate(data->acceleration_sensor);

	data->magnetic_sensor->needed |= WAVE_SENSORS_NEEDED_ORIENTATION;
	if (data->magnetic_sensor->needed == WAVE_SENSORS_NEEDED_ORIENTATION)
...
int orientation_deactivate(struct wave_sensors_handlers *handlers)
{
	struct orientation_data *data;
...
int orientation_set_delay(struct wave_sensors_handlers *handlers,
	long int delay)
{
	struct orientation_data *data;
...
int orientation_get_data(struct wave_sensors_handlers *handlers,
...
struct wave_sensors_handlers orientation = {
	.name = "Orientation",
