 ...
 *
 * Problems:
 * 1. Galaxy S's GPS library was made to work with android L
...
void _ZN7android13SensorManagerC1Ev(void *sensorMgr)
{
    ...
    _ZN7android8String16C1EPKc(&string, "gps.galaxysmtd");
...
{
    ALOGI("Galaxy S GPS interposition library loaded. Your GPS should work in M now.");
}
...
{
    ALOGI("Galaxy S GPS interposition library unloading. Goodbye...");
